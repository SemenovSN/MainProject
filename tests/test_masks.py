...
def test_get_mask_card_number():
    # тест - номер карты в int корректной длинны
    assert get_mask_card_number(1234567890123456) == "1234 56** **** 3456"
    # тест - номер карты str корректной длинны
    assert get_mask_card_number("1234567890123456") == "1234 56** **** 3456"
    # тест - номер карты в int некорректной длинны
...
def test_get_mask_account():
    # тест - номер счета в int корректной длинны
